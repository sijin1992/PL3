...
class RankItem : public ::google::protobuf::MessageLite {
 public:
  RankItem();
  virtual ~RankItem();
 ...
 private:
  ...
  #ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  friend void  protobuf_AddDesc_rank_2eproto_impl();
  #else
...
class RankPlayerInfo : public ::google::protobuf::MessageLite {
 public:
  RankPlayerInfo();
  ...
  // for Protobuf internal code. Please use default_instance() declared
  // above instead.
  static inline const RankPlayerInfo* internal_default_instance() {
    return default_instance_;
  }
  #endif
...
class RankExtData : public ::google::protobuf::MessageLite {
 public:
  RankExtData();
  virtual ~RankExtData();
  ...
  // for Protobuf internal code. Please use default_instance() declared
  // above instead.
  static inline const RankExtData* internal_default_instance() {
    return default_instance_;
  }
  #endif
...
class RankCallBack : public ::google::protobuf::MessageLite {
 public:
  RankCallBack();
  ...
  // for Protobuf internal code. Please use default_instance() declared
  // above instead.
  static inline const RankCallBack* internal_default_instance() {
    return default_instance_;
  }
  #endif
...
class RankItemList : public ::google::protobuf::MessageLite {
 public:
  RankItemList();
  ...
  // for Protobuf internal code. Please use default_instance() declared
  // above instead.
  static inline const RankItemList* internal_default_instance() {
    return default_instance_;
  }
  #endif
...
#ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  return extdata_ != NULL ? *extdata_ : *default_instance().extdata_;
#else
