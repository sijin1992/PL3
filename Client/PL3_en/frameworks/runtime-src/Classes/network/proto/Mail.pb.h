...
class PlanetReport : public ::google::protobuf::MessageLite {
 public:
  PlanetReport();
  ...
  // above instead.
  static inline const PlanetReport* internal_default_instance() {
...
class Mail : public ::google::protobuf::MessageLite {
 public:
  Mail();
  virtual ~Mail();
...
class MailList : public ::google::protobuf::MessageLite {
 public:
  MailList();
  virtual ~MailList();
...
#ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  return planet_report_ != NULL ? *planet_report_ : *default_instance().planet_report_;
#else
