...
class PvpReq : public ::google::protobuf::MessageLite {
 public:
  PvpReq();
  virtual ~PvpReq();
  ...
  // above instead.
  static inline const PvpReq* internal_default_instance() {
 ...
 private:
  ...
  #ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  friend void  protobuf_AddDesc_CmdPvp_2eproto_impl();
  #else
...
class PvpResp : public ::google::protobuf::MessageLite {
 public:
  PvpResp();
  virtual ~PvpResp();
  ...
  // for Protobuf internal code. Please use default_instance() declared
  // above instead.
  static inline const PvpResp* internal_default_instance() {
    return default_instance_;
  }
  #endif
...
class VideoData : public ::google::protobuf::MessageLite {
 public:
  VideoData();
  virtual ~VideoData();
...
class PvpVideoReq : public ::google::protobuf::MessageLite {
 public:
  PvpVideoReq();
  virtual ~PvpVideoReq();
  ...
  // for Protobuf internal code. Please use default_instance() declared
  // above instead.
  static inline const PvpVideoReq* internal_default_instance() {
    return default_instance_;
  }
  #endif
...
class PvpVideoResp : public ::google::protobuf::MessageLite {
 public:
  PvpVideoResp();
  ...
  // for Protobuf internal code. Please use default_instance() declared
  // above instead.
  static inline const PvpVideoResp* internal_default_instance() {
    return default_instance_;
  }
  #endif
