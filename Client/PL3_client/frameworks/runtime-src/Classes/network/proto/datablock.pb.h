...
class DataBlock : public ::google::protobuf::MessageLite {
 public:
  DataBlock();
  virtual ~DataBlock();
 ...
 private:
  ...
  #ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  friend void  protobuf_AddDesc_datablock_2eproto_impl();
  #else
...
class DataBlockSet : public ::google::protobuf::MessageLite {
 public:
  DataBlockSet();
  ...
  // for Protobuf internal code. Please use default_instance() declared
  // above instead.
  static inline const DataBlockSet* internal_default_instance() {
    return default_instance_;
  }
  #endif
