...
class RankGetReq : public ::google::protobuf::MessageLite {
 public:
  RankGetReq();
  virtual ~RankGetReq();
  ...
  // above instead.
  static inline const RankGetReq* internal_default_instance() {
 ...
 private:
  ...
  #ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  friend void  protobuf_AddDesc_cmd_5frank_2eproto_impl();
  #else
