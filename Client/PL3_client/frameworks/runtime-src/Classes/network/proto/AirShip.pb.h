...
class AirShip : public ::google::protobuf::MessageLite {
 public:
  AirShip();
  virtual ~AirShip();
  ...
  // above instead.
  static inline const AirShip* internal_default_instance() {
 ...
 private:
  ...
  #ifdef GOOGLE_PROTOBUF_NO_STATIC_INITIALIZER
  friend void  protobuf_AddDesc_AirShip_2eproto_impl();
  #else
...
class ShipList : public ::google::protobuf::MessageLite {
 public:
  ShipList();
  virtual ~ShipList();
  ...
  // for Protobuf internal code. Please use default_instance() declared
  // above instead.
  static inline const ShipList* internal_default_instance() {
    return default_instance_;
  }
  #endif
