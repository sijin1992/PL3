...
static unsigned char digest_len = SHA_DIGESTSIZE;

/* Hash a single 512-bit block. This is the core of the algorithm. */
static void SHA1Transform(__u32 state[5], __u8 buffer[64])
{
    __u32 a, b, c, d, e;
    typedef union {
        unsigned char c[64];
...
static void SHA1Update(SHA1_CTX* context, unsigned char* data, __u32 len)
{
	__u32 i, j;
              ...
              void *digest) /* the right digest data */
{
	...
	unsigned char keys[SHA_DIGESTSIZE];
