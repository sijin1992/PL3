int StringHelper::toSql(const StringVector &vec, char *buff, unsigned &size)
{
	...
	{
		size = snprintf(buff, size, "INSERT IGNORE INTO LOG_PVE (`time_stamp`, `areaid`, `uid`, `pveid`, `star`) VALUES ('%s', '%s', '%s', '%s', '%s')",
			getStamp(vec[0]), getAreaID(vec, 5), str(vec, 5), str(vec, 6), str(vec, 7));
	}
	else if (statType == STAT_LOG_BUILD ) 
	{
		size = snprintf(buff, size, "INSERT IGNORE INTO LOG_BUILD (`time_stamp`, `areaid`, `uid`, `type`, `level`) VALUES ('%s', '%s', '%s', '%s', '%s')",
			getStamp(vec[0]), getAreaID(vec, 5), str(vec, 5), str(vec, 6), str(vec, 7));
	}
	else if (statType == STAT_LOG_RES ) 
	{
		size = snprintf(buff, size, "INSERT IGNORE INTO LOG_RES (`time_stamp`, `areaid`, `uid`, `resid`, `add`, `num`) VALUES ('%s', '%s', '%s', '%s', '%s', '%s')",
			getStamp(vec[0]), getAreaID(vec, 5), str(vec, 5), str(vec, 6), str(vec, 7), str(vec, 8));
	}
	else if (statType == STAT_LOG_SHIP ) 
	{
		size = snprintf(buff, size, "INSERT IGNORE INTO LOG_SHIP (`time_stamp`, `areaid`, `uid`, `shipid`, `shiplevel`) VALUES ('%s', '%s', '%s', '%s', '%s')",
			getStamp(vec[0]), getAreaID(vec, 5), str(vec, 5), str(vec, 6), str(vec, 7));
	}
	else if (statType == STAT_LOG_BUY_ITEM ) 
	{
		size = snprintf(buff, size, "INSERT IGNORE INTO LOG_BUY_ITEM (`time_stamp`, `areaid`, `uid`, `itemid`, `itemnum`, `money`) VALUES ('%s', '%s', '%s', '%s', '%s', '%s')",
			getStamp(vec[0]), getAreaID(vec, 5), str(vec, 5), str(vec, 6), str(vec, 7), str(vec, 8));
	}
	else if (statType == STAT_LOG_USE_MONEY ) 
	{
		size = snprintf(buff, size, "INSERT IGNORE INTO LOG_USE_MONEY (`time_stamp`, `areaid`, `uid`, `type`, `add`, `num`) VALUES ('%s', '%s', '%s', '%s', '%s', '%s')",
			getStamp(vec[0]), getAreaID(vec, 5), str(vec, 5), str(vec, 6), str(vec, 7), str(vec, 8));
	}
	else if (statType == STAT_LOG_CAST_OD)
	{
		size = snprintf(buff, size, "INSERT IGNORE INTO LOG_CAST_OD (`time_stamp`, `areaid`, `uid`, `type`, `od`, `money`, `extinfo`, `allmoney`) VALUES ('%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s')",
			getStamp(vec[0]), getAreaID(vec, 5), str(vec, 5), str(vec, 6), str(vec, 7), str(vec, 8), str(vec, 9), str(vec, 10));
	}
	return 0;
}
