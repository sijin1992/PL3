#ifndef __MAIN_LOGIC_CHAT_H__
#define __MAIN_LOGIC_CHAT_H__
...
#include "usergroup.h"
class CLogicChat;
class CLogicChatGroupHookImp: public CLogicUserGroupHook
{
public:
	CLogicChat* pobj;
public:
	virtual ~CLogicChatGroupHookImp(){}	
	int hook_on_state(int retcode, int state, GroupMainData* pdata);
};


class CLogicChat:public CUserDataBase
{
public:
