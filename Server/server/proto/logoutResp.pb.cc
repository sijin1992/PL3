...
const ::google::protobuf::EnumDescriptor* LogoutResp_Result_descriptor_ = NULL;

}  // namespace


void protobuf_AssignDesc_logoutResp_2eproto() {
  protobuf_AddDesc_logoutResp_2eproto();
  const ::google::protobuf::FileDescriptor* file =
    ::google::protobuf::DescriptorPool::generated_pool()->FindFileByName(
      "logoutResp.proto");
  GOOGLE_CHECK(file != NULL);
  LogoutResp_descriptor_ = file->message_type(0);
  ...
  LogoutResp_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ...
      sizeof(LogoutResp));
  LogoutResp_Result_descriptor_ = LogoutResp_descriptor_->enum_type(0);
}
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_logoutResp_2eproto);
}
...
void protobuf_AddDesc_logoutResp_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\020logoutResp.proto\"U\n\nLogoutResp\022\"\n\006resu"
    "lt\030\001 \002(\0162\022.LogoutResp.Result\"#\n\006Result\022\021"
    "\n\004FAIL\020\377\377\377\377\377\377\377\377\377\001\022\006\n\002OK\020\000", 105);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "logoutResp.proto", &protobuf_RegisterTypes);
  LogoutResp::default_instance_ = new LogoutResp();
  LogoutResp::default_instance_->InitAsDefaultInstance();
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_logoutResp_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_logoutResp_2eproto {
  StaticDescriptorInitializer_logoutResp_2eproto() {
    protobuf_AddDesc_logoutResp_2eproto();
  }
} static_descriptor_initializer_logoutResp_2eproto_;

// ===================================================================

const ::google::protobuf::EnumDescriptor* LogoutResp_Result_descriptor() {
  protobuf_AssignDescriptorsOnce();
  return LogoutResp_Result_descriptor_;
}
...
#ifndef _MSC_VER
const LogoutResp_Result LogoutResp::FAIL;
const LogoutResp_Result LogoutResp::OK;
const LogoutResp_Result LogoutResp::Result_MIN;
const LogoutResp_Result LogoutResp::Result_MAX;
const int LogoutResp::Result_ARRAYSIZE;
#endif  // _MSC_VER
#ifndef _MSC_VER
...
const LogoutResp& LogoutResp::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_logoutResp_2eproto();
      ...
      case 1: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                 ...
                 input, &value)));
          if (::LogoutResp_Result_IsValid(value)) {
            set_result(static_cast< ::LogoutResp_Result >(value));
          } else {
