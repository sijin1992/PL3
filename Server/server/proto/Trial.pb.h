...
class TrialLevel : public ::google::protobuf::Message {
 public:
  TrialLevel();
  virtual ~TrialLevel();
...
class TrialShip : public ::google::protobuf::Message {
 public:
  TrialShip();
  virtual ~TrialShip();
...
class TrialCopy : public ::google::protobuf::Message {
 public:
  TrialCopy();
  virtual ~TrialCopy();
...
class TrialArea : public ::google::protobuf::Message {
 public:
  TrialArea();
  virtual ~TrialArea();
...
class TrialData : public ::google::protobuf::Message {
 public:
  TrialData();
  virtual ~TrialData();
