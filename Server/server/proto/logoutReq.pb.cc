...
void protobuf_AssignDesc_logoutReq_2eproto() {
  ...
  static const int LogoutReq_offsets_[1] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(LogoutReq, nothing_),
  };
...
#ifndef _MSC_VER
const int LogoutReq::kNothingFieldNumber;
#endif  // !_MSC_VER
...
void LogoutReq::SerializeWithCachedSizes(
  ...
  // required uint32 nothing = 1;
  if (has_nothing()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(1, this->nothing(), output);
  }
...
::google::protobuf::uint8* LogoutReq::SerializeWithCachedSizesToArray(
  ...
  // required uint32 nothing = 1;
  if (has_nothing()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(1, this->nothing(), target);
  }
