...
inline const ::std::string& SlaveNoteInfo_SlaveNoteType_Name(SlaveNoteInfo_SlaveNoteType value) {
  return ::google::protobuf::internal::NameOfEnum(
    SlaveNoteInfo_SlaveNoteType_descriptor(), value);
}
inline bool SlaveNoteInfo_SlaveNoteType_Parse(
    const ::std::string& name, SlaveNoteInfo_SlaveNoteType* value) {
  return ::google::protobuf::internal::ParseNamedEnum<SlaveNoteInfo_SlaveNoteType>(
    SlaveNoteInfo_SlaveNoteType_descriptor(), name, value);
}
// ===================================================================

class SlaveNoteInfo : public ::google::protobuf::Message {
 public:
  SlaveNoteInfo();
  ...
  SlaveNoteType_descriptor() {
    return SlaveNoteInfo_SlaveNoteType_descriptor();
  }
  static inline const ::std::string& SlaveNoteType_Name(SlaveNoteType value) {
    return SlaveNoteInfo_SlaveNoteType_Name(value);
  }
  static inline bool SlaveNoteType_Parse(const ::std::string& name,
      SlaveNoteType* value) {
    return SlaveNoteInfo_SlaveNoteType_Parse(name, value);
  }
...
class SlaveData : public ::google::protobuf::Message {
 public:
  SlaveData();
  virtual ~SlaveData();
...
class SlaveBriefInfo : public ::google::protobuf::Message {
 public:
  SlaveBriefInfo();
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::SlaveNoteInfo_SlaveNoteType>() {
  return ::SlaveNoteInfo_SlaveNoteType_descriptor();
}
