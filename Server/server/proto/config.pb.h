...
class ConfValue : public ::google::protobuf::Message {
 public:
  ConfValue();
  virtual ~ConfValue();
...
class ConfigRow : public ::google::protobuf::Message {
 public:
  ConfigRow();
  virtual ~ConfigRow();
...
class ConfigTable : public ::google::protobuf::Message {
 public:
  ConfigTable();
  virtual ~ConfigTable();
...
class nick_name_ctrl : public ::google::protobuf::Message {
 public:
  nick_name_ctrl();
