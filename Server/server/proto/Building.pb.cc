...
void protobuf_AssignDesc_Building_2eproto() {
  ...
  BuildingInfo_descriptor_ = file->message_type(0);
  static const int BuildingInfo_offsets_[4] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(BuildingInfo, level_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(BuildingInfo, upgrade_begin_time_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(BuildingInfo, helped_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(BuildingInfo, upgrade_exp_),
  };
...
void protobuf_AddDesc_Building_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\016Building.proto\"^\n\014BuildingInfo\022\r\n\005leve"
    "l\030\001 \002(\005\022\032\n\022upgrade_begin_time\030\002 \001(\005\022\016\n\006h"
    "elped\030\003 \001(\010\022\023\n\013upgrade_exp\030\004 \001(\005", 112);
...
::google::protobuf::uint8* BuildingInfo::SerializeWithCachedSizesToArray(
  ...
  // optional int32 upgrade_begin_time = 2;
  if (has_upgrade_begin_time()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(2, this->upgrade_begin_time(), target);
  }
  ...
  // optional int32 upgrade_exp = 4;
  if (has_upgrade_exp()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(4, this->upgrade_exp(), target);
  }
